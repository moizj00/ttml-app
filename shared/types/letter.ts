...
export const ALLOWED_TRANSITIONS: Record<string, string[]> = {
  ...
  under_review: ["approved", "client_approval_pending", "rejected", "needs_changes", "pending_review"],
...
> = {
  ...
  "general-legal": {
    ...
    intakeHints: {
      ...
      desiredOutcomePlaceholder: "e.g., Resolution of the matter within 30 days.",
    },
  },
};
