...
const CONTENT_BRIEFS = [
  ...
  },
  {
    ...
    posts: [
      ...
      {
        title: "How AI Is Changing Legal Services for Individuals",
        targetKeyword: "AI legal services",
        searchIntent: "Informational — people curious about AI in law",
        outline: [
          "The Problem: Legal Services Are Too Expensive for Most People",
          "How AI Is Making Legal Help Accessible",
          "AI Drafting + Attorney Review: The Best of Both Worlds",
          "What AI Can and Can't Do in Legal Services",
          "The Future of Affordable Legal Assistance",
        ],
        internalLinks: ["/", "/pricing", "/faq"],
        cta: "Experience AI-powered legal letter drafting with attorney review",
        repurpose: {
          linkedin: "Traditional legal letters cost $500–$2,000 and take weeks. AI drafting + attorney review delivers the same quality in 24 hours for $200. Here's how.",
          twitter: "AI is making legal services accessible to everyone. Here's how the industry is changing — and what it means for you 🧵",
          newsletter: "The future of legal services: How AI drafting + attorney review is making professional legal letters affordable for everyone.",
        },
      },
      {
