...
ALTER TABLE "letter_requests" ADD COLUMN "submitter_role_id" varchar(16);--> statement-breakpoint
ALTER TABLE "letter_requests" ADD COLUMN "reviewer_role_id" varchar(16);--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "subscriber_id" varchar(16);--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "employee_id" varchar(16);--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "attorney_id" varchar(16);--> statement-breakpoint
