  ...
  app.use((_req, res, next) => {
    ...
    if (!isDev) {
      res.setHeader(
        ...
        [
          "default-src 'self'",
          "script-src 'self' https://js.stripe.com https://js.hcaptcha.com https://newassets.hcaptcha.com",
          "style-src 'self' 'unsafe-inline' https://newassets.hcaptcha.com https://fonts.googleapis.com",
          "img-src 'self' data: https: blob:",
          "font-src 'self' data: https://newassets.hcaptcha.com https://fonts.gstatic.com",
          "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://hcaptcha.com https://*.hcaptcha.com",
