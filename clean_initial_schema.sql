...
CREATE INDEX "idx_letter_requests_status" ON "letter_requests" USING btree ("status");
CREATE INDEX "idx_letter_requests_user_id" ON "letter_requests" USING btree ("user_id");
CREATE INDEX "idx_letter_requests_assigned_reviewer" ON "letter_requests" USING btree ("assigned_reviewer_id");
CREATE INDEX "idx_letter_versions_letter_request_id" ON "letter_versions" USING btree ("letter_request_id");
CREATE INDEX "idx_research_runs_letter_request_status" ON "research_runs" USING btree ("letter_request_id","status");
CREATE INDEX "idx_review_actions_letter_request_id" ON "review_actions" USING btree ("letter_request_id");
CREATE INDEX "idx_workflow_jobs_letter_request_status" ON "workflow_jobs" USING btree ("letter_request_id","status");ALTER TABLE "letter_requests" ADD COLUMN IF NOT EXISTS "pdf_url" text;